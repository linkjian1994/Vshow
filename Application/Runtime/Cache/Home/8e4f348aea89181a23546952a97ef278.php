...
<!--  <div id="header">
    ...
    <div class="ucenter">
      ...
      <div class="column-box5 column-box4-box5 r-content">
                    <?php if(empty($collectList)): ?><div class="empty-message">
                            您还没有收藏哦
                        </div><?php endif; ?>
                    <?php if(is_array($collectList)): $i = 0; $__LIST__ = $collectList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list clearfix">
                            <div class="img-wrap2 fl">
                                ...
                                <div class="list-cont fl">
                                    ...
                                    <p>
                                        <span>作者:</span><em class="author-name"><a href="#"><?php echo ($vo["works_author"]); ?></a></em>
                                    </p>
                                    <p> </p>
                                    <p>
                                        <span class="time">收藏时间:</span><em class="time"><?php echo (date("Y-m-d",$vo["operate_time"])); ?></em>
                                    </p>
                                    <ul class="other">
                                        <li><a href="javascript:;" class="delete-collect" oid="<?php echo ($vo["oid"]); ?>" wid="<?php echo ($vo["id"]); ?>">取消收藏</a></li>
                                    </ul>                           
                                </div>            
