...
class VshowPage{
    ...
    public function show() {
        ...
        $up_page = $up_row > 0 ? '<li><a class="prev" href="javasctipt:' . $this->url($up_row) . '">' . $this->config['prev'] . '</a></li>' : '';
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page > 0 && $this->totalPages != 1){
                    $link_page .= '<li><a class="current active" href="#'.$page.'">' . $page . '</a></li>';
                }
            }
        }
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return "<ul class='clearfix'>{$page_str}</ul>";
    }
}
