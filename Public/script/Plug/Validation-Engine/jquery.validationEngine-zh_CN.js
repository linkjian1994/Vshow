	...
	$.validationEngineLanguage = {
		newLang:function(){
			$.validationEngineLanguage.allRules = {
				...
				"checkFieldUnqiue": {
					"url": root+"/Home/User/checkFieldUnqiue",
					"alertTextOk": "* 验证通过，可以使用",
					"alertText": "* 已被其他人使用，请尝试更换",
					"alertTextLoad": "* 正在确认是否有其他人使用，请稍等。"
				},
				"checkVerifyCode": {
					"url": root+"/Home/User/checkVerifyCode",
					"alertTextOk": "* 验证码输入正确",
					"alertText": "* 验证码输入错误，请重试",
					"alertTextLoad": "* 正在检查验证码，请稍等 "
				},
				"checkNewPwd": {
				 		"alertText": "*新密码不能和原密码相同"
				 },
				/**
				 * 自定义公用提示信息：
